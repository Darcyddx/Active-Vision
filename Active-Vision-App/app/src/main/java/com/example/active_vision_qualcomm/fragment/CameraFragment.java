package com.example.active_vision_qualcomm.fragment;
...
import com.example.active_vision_qualcomm.FragmentRender;
import com.example.active_vision_qualcomm.FrameAnalyzer;
import com.example.active_vision_qualcomm.R;
...
public class CameraFragment extends Fragment implements TrackerResListener {
     ...
     */
    public static CameraFragment newInstance(TennisTracker tracker,
