...
def main(args):
    ...
    a = img_to_array(load_img(p, color_mode="grayscale"))  # Load as grayscale
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate heatmap data for tennis tracking.")
    parser.add_argument('--data_path', type=str, required=True, help="Root path of the dataset.")
    parser.add_argument('--save_dir', type=str, required=True, help="Output directory for npz files.")
